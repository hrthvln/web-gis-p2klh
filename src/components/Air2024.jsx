...
const handlePopupToggle = (popupName) => {
  ...
  useEffect(() => {
    if (map) {
      ...
      toggleBoundaryLayer().then(() => {
        ...
        loadAirPointLayer(udaraLayer, setUdaraLayer, '/map/titikUdara_2024.geojson', pointColors.udara);
      });
        ...
        if (checked) {
          ...
          const popupContent = `
            <div style="font-family: Arial, sans-serif; width: 100%; max-width: 400px; padding: 15px;">
              <h2 style="font-size: 16px; font-weight: bold; text-align: center; margin-bottom: 15px;">NILAI IKU DIY 2024</h2>
              <div style="margin-bottom: 15px;">
                <h4 style="font-size: 14px; font-weight: bold;">• Nilai IKU Kabupaten/Kota 2024</h4>
              ...
              <div>
                <h4 style="font-size: 14px; font-weight: bold;">• Nilai IKU Provinsi 2024</h4>
  ...
  const handleYearChange = (year) => {
    ...
    if (year === 2024) {
      navigate("/maps/kualitas-udara-2024");
    } else if (year === 2023) {
      navigate("/maps/kualitas-udara-2023");
    }
  };
