  ...
  useEffect(() => {
    if (map) {
      ...
      toggleBoundaryLayer().then(() => {
        ...
        loadSeaPointLayer(oneSeaLayer, setOneSeaLayer, '/map/titikLaut1_2023.geojson', pointColors.oneSea);
      });
  ...
  const handleLayerToggle = (checked, layerName) => {
    switch (layerName) {
      ...
      case 'twoSea':
        ...
        if (checked) {
          loadSeaPointLayer(twoSeaLayer, setTwoSeaLayer, '/map/titikLaut2_2023.geojson', pointColors.twoSea);
